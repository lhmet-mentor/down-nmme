...
7. `join-prec-cru-nmme.R`:
  ...
  - arquivos de saída em `output/rds/basin/avgs/{sp_average}` no fomato RDS no padrão `nmme-cru-mly-{sp_average}-avg-basins-ons.RDS` (cada arquivo em torno de 180 MB)
