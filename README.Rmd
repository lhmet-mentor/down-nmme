...
8. `aggregate-members.R`: 
  ...
  - depende do script `aggregate-nmme.R` que contém funções para:
    
    - calcular a média dos modelos do NMME a partir de seus membros; 
    
    - calcular a média ensemble dos modelos a partir dos modelos do NMME; 
    
    - juntar as médias dos modelos com a média do ensemble
  ...
  - arquivo de saída em `output/{ext}/basin-avgs/{sp_average}/nmme-mly-models-avgs-ens-mean-1982-2010-prec.qs`.
